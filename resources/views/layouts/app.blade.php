    ...
    <div x-show="open" class="relative px-2">
     ...
     <div class="flex-1 overflow-y-auto custom-scrollbar text-xs">
        <nav class="flex flex-col space-y-1 text-[var(--color-secondtext)]">
                ...
                <a href="{{ route('reports.index') }}" class="menu-item flex items-center gap-2 {{ request()->routeIs('reports.*') ? 'active' : '' }}"><x-heroicon-o-document-chart-bar class="w-5 h-5 flex-shrink-0"/><span x-show="open">Reports and Analytics</span></a>
                ...
                <a href="{{ route('goals.index') }}" class="menu-item flex items-center gap-2 {{ request()->routeIs('goals.*') ? 'active' : '' }}"><x-heroicon-o-list-bullet class="w-5 h-5 flex-shrink-0"/><span x-show="open">Goals</span></a>
